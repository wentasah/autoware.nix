...
buildRosPackage rec {
  ...
  src = fetchFromGitHub {
    ...
    sha256 = "1ypsbjbq03xypy29yadm0zyvib1y7kijkw92fkiljnkk5wr167mj";
    sparseCheckout = ["planning/behavior_velocity_planner/autoware_behavior_velocity_no_stopping_area_module/"];
    nonConeMode = true;
  };
