...
buildRosPackage rec {
  ...
  src = fetchFromGitHub {
    ...
    sha256 = "012k5diwl1xskqrcwhkqg7ixahd5lklk43v9iyhm177sjgy55yfm";
    sparseCheckout = ["planning/behavior_path_planner/autoware_behavior_path_dynamic_obstacle_avoidance_module/"];
    nonConeMode = true;
  };
