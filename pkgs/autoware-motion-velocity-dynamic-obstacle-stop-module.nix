...
buildRosPackage rec {
  ...
  src = fetchFromGitHub {
    ...
    sha256 = "0qyjdspi89x8wkiq6zqi6brkiclw22q3ihd0n1wavyzsprp5phi5";
    sparseCheckout = ["planning/motion_velocity_planner/autoware_motion_velocity_dynamic_obstacle_stop_module/"];
    nonConeMode = true;
  };
