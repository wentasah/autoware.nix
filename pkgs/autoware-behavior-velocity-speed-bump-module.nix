...
buildRosPackage rec {
  ...
  src = fetchFromGitHub {
    ...
    sha256 = "0dvm057815w9zq8p9ar9m24a9iqnbsdashwx76y76izby1ydr2a4";
    sparseCheckout = ["planning/behavior_velocity_planner/autoware_behavior_velocity_speed_bump_module/"];
    nonConeMode = true;
  };
