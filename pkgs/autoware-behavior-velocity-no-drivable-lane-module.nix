...
buildRosPackage rec {
  pname = "ros-rolling-autoware-behavior-velocity-no-drivable-lane-module";
  version = "0.39.0";
  ...
  src = fetchFromGitHub {
    ...
    sha256 = "1w9j1drgqdj7461imdcnb9ap7fxw0qizxnm6jl246qq6vhzmp9cq";
    sparseCheckout = ["planning/behavior_velocity_planner/autoware_behavior_velocity_no_drivable_lane_module/"];
    nonConeMode = true;
  };

  buildType = "ament_cmake";
  sourceRoot = "${src.name}/planning/behavior_velocity_planner/autoware_behavior_velocity_no_drivable_lane_module/";
  ...
  meta = {
    description = "The autoware_behavior_velocity_no_drivable_lane_module package";
